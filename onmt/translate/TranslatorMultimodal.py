...
class MultimodalTranslator(Translator):
    def translate(self, src_dir, src_path, tgt_path,
        ...
        for batch in data_iter:
            batch_data = self.translate_batch(batch, data, test_img_feats)
    ...
    def translate_batch(self, batch, data, test_img_feats):
        """
        ...
        img_feats = torch.from_numpy(test_img_feats[idxs])
        if self.cuda:
